...
Run from the project root. This script adds the repo root to sys.path,
sets DJANGO_SETTINGS_MODULE if missing, imports Django and prints
settings.DATABASES so we can see which DB is active.
"""
